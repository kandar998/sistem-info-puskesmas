...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-plus-circle me-2"></i>Tambah Jadwal Pemeriksaan
            </h1>
            <p class="text-muted small">Buat jadwal pemeriksaan baru untuk pasien</p>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            <form action="{{ route('admin.jadwal-pemeriksaan.store') }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-select @error('poli') is-invalid @enderror"
                                ...
                                <option value="KB" {{ old('poli') == 'KB' ? 'selected' : '' }}>Poli KB</option>
                                <option value="Lansia" {{ old('poli') == 'Lansia' ? 'selected' : '' }}>Poli Lansia</option>
                            </select>
                            @error('poli')
